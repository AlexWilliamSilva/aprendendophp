...
<body>
    ...
    <ul>
        <li>i>Os nomes de usuários devem conter apenas dígitos, letras maiúsculas e 
        ...
        <li>>As senhas devem conter
            <ul>
                <li>i>Pelo menos uma letra maiúscula (A..Z)</li>
                <li>li>Pelo menos uma letra minúscula (a..z)</li>
                <li>i>Pelo menos um número (0..9)</li>
